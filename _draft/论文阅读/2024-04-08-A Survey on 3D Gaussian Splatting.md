...
**3D Gaussian splatting（3D GS）**：explicit radiance field 和 computer graphics 的一项变革性的技术
# 1.  研究领域和主要问题

# 2. 方法
3D Gaussian splatting：利用数百万个 3D 高斯函数
- 好处：
neural radiance field（NeRF）：使用隐式的、基于坐标的模型将空间坐标映射到像素值
